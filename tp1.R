...
# c'est E qui a la plus petite corrélation (plus proche de 0), car c'est une parabole
...
#Question_4
# Il existe diverses façons de calculer la relation non-lineaire et non-monotone entre
#variables E et Y tel que : faire une transformation, utiliser une fonction non-linéaire...
...
#degré de liberté : n - 1 (15 - 1 = 14). On remarque que dans le fichier pdf la valeur est de 2.145 
...
#degré de liberté : n + n - 2 (15 + 15 - 2 = 28)
# avec alpha = 5% : étant donné que le resultat obtenu est de 2.32 au lieu de 2.048 
# il y a une dépendance significative entre Marseille et Aix. 
# avec alpha = 2% : on a 2.468 ce qui est nettement plus proche et supérieur à notre valeur, 
#il y a donc moins de dépendance.
...
rownames(senteur) <- c("ratio génétique", "observé")
...
#7.81 donc nous sommes largement au dessus l'hypothèse est fausse.
...
#Question_9
#D'après les questions précedentes, le test Student/t est parametrique car il se base sur une distribution 
